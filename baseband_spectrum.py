...
def baseband_spectrum(x, Ts, BW, winval='blackman', return_onesided=True, scaling='density'):
    ...
    # if single side density
    Ns = len(spectro)

    f = np.arange(-1/2,1/2,1/Ns)/Ts
    # convert to V**2/Hz
    if scaling=='density':    
        spectro = spectro/AF
